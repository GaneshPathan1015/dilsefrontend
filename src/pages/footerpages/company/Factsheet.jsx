                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <img
                                src="https://www.withclarity.com/cdn/shop/files/in_the_news_desk_990x.jpg?v=1684248399"
                                alt=""
                                width="100%"
                            />
                        </div>
            ...
            <section className='mt-4 mb-4'>
                <div className="container">
                    ...
                    <div className='text-center' style={{ padding: '40px 20px' }}>
                        <h1 style={{ color: '#14344a' }}>The Caratcasa Facts</h1>
                        <p style={{ fontSize: "17px" }}>The Caratcasa is the better way to shop for diamond engagement rings. We've married <br /> the best of online and offline shopping. Our focus is on offering impeccable quality, <br /> beautiful designs all at an affordable price.</p>
                    </div>

                    <div className="row text-center">
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_access_345x_6e014823-a3cc-459a-baab-aa9e30c41dee_345x.png?v=1695984600" alt="" width="70%" style={{ justifySelf: "center" }} />
                        ...
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_nyc_345x_eb2348b6-c7d3-4a83-882b-dfa69030b207_345x.png?v=1695984621" alt="" width="70%" style={{ justifySelf: "center" }} />
                                <h2 className='text-uppercase' style={{ margin: "25px 0 20px", fontSize: "24px", color: "#14344a" }}>NYC</h2>
                                <h3 className='text-uppercase' style={{ marginBottom: "20px", fontSize: "20px", color: "#14344a" }}>MADE IN NEW YORK CITY</h3>
                        ...
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_Years_of_Relationship_345x_a26b5cc1-9c32-4a88-863f-dca0ba11198b_345x.png?v=1695984643" alt="" width="70%" style={{ justifySelf: "center" }} />
                        ...
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_Preview_345x_36a5294a-c0a7-42ba-ade5-1581308fd0f9_345x.png?v=1695984666" alt="" width="70%" style={{ justifySelf: "center" }} />
                        ...
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_Recycled_345x_e53f7c03-0135-4f9b-b67b-d99fc69d072d_345x.png?v=1695984683" alt="" width="70%" style={{ justifySelf: "center" }} />
                        ...
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_PRICING_345x_c0cacd8c-48d7-4da7-bb23-de86057faec4_345x.png?v=1695984701" alt="" width="70%" style={{ justifySelf: "center" }} />
                                <h2 className='text-uppercase' style={{ margin: "25px 0 20px", fontSize: "24px", color: "#14344a" }}>PRICING</h2>
                                <h3 className='text-uppercase' style={{ marginBottom: "20px", fontSize: "20px", color: "#14344a" }}>LEGACY IN DIAMOND AND JEWELRY INDUSTRY</h3>
                                <p style={{ fontSize: "18px" }}>The Caratcasa can be 30% less expensive than an in store shopping experience. We offer fair pricing for beautiful ring designs and GIA certified diamonds.</p>
                            </div>
                        </div>
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_customization_345x_75b5221f-fa92-4236-a285-dffa7acd37e8_345x.png?v=1695984717" alt="" width="70%" style={{ justifySelf: "center" }} />
                        ...
                        <div className="col-md-3">
                            <div>
                                <img src="https://www.withclarity.com/cdn/shop/files/fact_Conflict-Free_345x_3e55d7ba-e3ee-4133-a8e8-efca56c85e45_345x.png?v=1695984734" alt="" width="70%" style={{ justifySelf: "center" }} />
                                ...
                                <p style={{ fontSize: "18px" }}>All The Caratcasa diamonds are vetted to be conflict free. Our relationships with our suppliers enable us to ensure that all diamonds are ethically sourced.</p>
                            </div>
                        </div>
                    </div>
                </div>
