              ...
              <div className="accordion" id="faqAccordion" style={{ color: '#14344a' }}>
                ...
                <div className="accordion-item">
                  ...
                  <div id="faq3" className="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                    <div className="accordion-body">
                      The Caratcasa wants your jewelry to shine as bright as the day it was purchased. We offer complimentary professional cleaning and polishing (excludes shipping fees). We recommend doing this once a year as part of regular servicing.
                      For day to day care, we recommend purchasing the The Caratcasa Luxury Jewelry Cleaner. Our cleaner removes dirt, oil, dust and other materials that reduce shine from daily use.
            ...
            <div className="accordion mb-5" id="faqFinancing">
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingFinancing1">
                  <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFinancing1">
                    What is the The Caratcasa Credit Card?
                  </button>
                </h2>
                <div id="collapseFinancing1" className="accordion-collapse collapse" data-bs-parent="#faqFinancing">
                  <div className="accordion-body">
                    The Caratcasa offers customers a credit card through Synchrony Bank with a revolving credit line to use again and again at withclarity.com. Please note only customers within the USA are eligible to apply and use the The Caratcasa Credit Card.
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingFinancing2">
                  <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFinancing2">
                    How do I apply for a The Caratcasa store credit card?
                  </button>
                </h2>
                <div id="collapseFinancing2" className="accordion-collapse collapse" data-bs-parent="#faqFinancing">
                  <div className="accordion-body">
                    You can apply for a The Caratcasa Store Credit Card here. Get a decision instantly.
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseFinancing3" className="accordion-collapse collapse" data-bs-parent="#faqFinancing">
                  <div className="accordion-body">
                    To check the status of your The Caratcasa Store Credit Card account,click here to learn more and manage your account on Synchrony Bank's website. After loging into your account, you will be able to:<br />
                    1. Make a payment <br />
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingFinancing4">
                  <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFinancing4">
                    How can I make a payment on my The Caratcasa store Credit Card?
                  </button>
                </h2>
            ...
            <div className="accordion mb-5" id="faqReplica">
              ...
              <div className="accordion-item">
                ...
                <div id="collapseReplica3" className="accordion-collapse collapse" data-bs-parent="#faqReplica">
                  <div className="accordion-body">
                    All our replica rings look exactly like real The Caratcasa engagement rings. Our Replica Rings are made of a white metallic alloy and round one carat diamond simulant. Just by looking at it, it's hard to tell a Replica Ring apart from a real diamond ring. Replica Rings are only intended for visual purposes, not extended wear, which may result in damage or tarnish.
                  </div>
                </div>
              </div>
            ...
            <div className="accordion mb-5" id="faqEthics">
              ...
              <div className="accordion-item">
                ...
                <div id="collapseEthics3" className="accordion-collapse collapse" data-bs-parent="#faqEthics">
                  <div className="accordion-body">
                    The most recent influx of conflict diamonds has been from mining in Zimbabwe's Marange diamond fields. Due to reports of human rights abuses, The Caratcasa does not purchase or inventory any diamonds that are associated or affiliated with Zimbabwean mining. The Caratcasa employs trained experts who can identify Zimbabwean diamonds that are in circulation, further ensuring our responsibility in purchasing and sourcing diamonds. The Caratcasa regularly reviews and improves its conflict diamond and environmental safety standards.
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingEthics4">
                  <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEthics4">
                    What is The Caratcasa's Conflict Diamond Policy?
                  </button>
                </h2>
                <div id="collapseEthics4" className="accordion-collapse collapse" data-bs-parent="#faqEthics">
                  <div className="accordion-body">
                    The Caratcasa is committed to the highest level of ethical responsibility. We understand that the diamond you purchase is a symbol of love and commitment. For this reason, we ensure that every diamond we offer is not tainted by conflict or human rights abuses. We work to enforce the strictest standards set forth by the Kimberley Process and United Nations Resolutions. At The Caratcasa, we're proud that the distribution of our jewelry, from mine to market, adheres with all international laws and human rights policies. With supplier relationships that span generations, we have transparency into the operations and sourcing of our suppliers. We only work with reputable suppliers who value conflict-free sourcing and ethical business practices.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="accordion mb-5" id="faqShipping">
              <div className="accordion-item">
                ...
                <div id="collapseShipping1" className="accordion-collapse collapse" data-bs-parent="#faqShipping">
                  <div className="accordion-body">
                    All The Caratcasa customers enjoy complimentary insured shipping on orders shipped within the United States, Canada and the UK. We provide shipment tracking so that you can keep track of when your package will arrive. All items shipping via FedEx will require a signature upon delivery.
                    ...
                    The Caratcasa insured shipping covers items that are lost, damaged or stolen during transit. We will make efforts to recover the item(s). If unrecoverable, we will offer an item of equal or similar quality and size to match your original order. Insurance coverage applies to the cost (not retail value) of the item, as provided by our insurers.
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseShipping2" className="accordion-collapse collapse" data-bs-parent="#faqShipping">
                  <div className="accordion-body">
                    If your billing and shipping address are different, The Caratcasa will gladly ship your jewelry to the preferred location. For security verification, we may use an email confirmation, government issued ID verification and/or telephone call to confirm the desired delivery address.
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseShipping5" className="accordion-collapse collapse" data-bs-parent="#faqShipping">
                  <div className="accordion-body">
                    The Caratcasa ships to personal residences, offices, and local FedEx/UPS locations. We do not ship to PO Boxes for security reasons. We can ship anywhere within the USA, Canada or the UK.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="accordion-item">
                ...
                <div id="collapseDiscount4" className="accordion-collapse collapse" data-bs-parent="#faqDiscount">
                  <div className="accordion-body">
                    ...
                    *The Caratcasa reserves the right to deactivate your code and cancel any outstanding orders if we believe it is being misused.
                  </div>
                </div>
              </div>
