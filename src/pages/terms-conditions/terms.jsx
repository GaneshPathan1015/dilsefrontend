    ...
    <>
      <section className="terms-policy">
        <div className="container position-relative">
          <div className="wrapper w-100 mb-3 ps-5">
            <div className="content-inner medium-up--one-half">
              <div className="section-heading">
                <h3
                  className="mb-2 mt-4 display-5 text-center"
              ...
              <div className="page-content">
                <p>
                  Welcome to https://dilsejewels.com (“The Dilse Jewels”). If there is
                ...
                <h2 className="display-12">Product Pricing and Availability</h2>
                <p>
                  Product data and pricing information, are updated regularly to
                  represent the most current or up to date information available
                  to us. Occasionally, product and pricing information may be
                  inaccurately displayed or represented on our site or by our
                  representatives/employees due to typographical, system, or
                ...
                <p>
                  Our product prices and availability are subject to change
                  without notice. If a product is no longer available because it
                  was sold, inaccurately represented or it was not updated at
                  the time of your order in our system, we will notify you
                  accordingly and offer a similar product(s). If an product of
                  interest is no longer available, please contact us and we can
                  let you know when the product or a similar product will be
                  available. We apologize in advance for any issues or
                ...
                <p>
                  ...
                  period. Any subsequent sales are final and the 30-day return
                  policy is not applicable. This policy is inclusive of
                  exchanges on diamonds and/or ring settings.
                </p>
                ...
                <p>
                  Please note that for all engagement rings with a lab grown
                  diamond center, all accent diamonds set within that engagement
                  ring will be lab accent diamonds. For an engagement ring with
                  a natural diamond center, all accent diamonds set within that
                  ring will be natural accent diamonds. Accent diamonds are
                  chosen to match each other and the center diamond.
                </p>
                <p>
                  Diamond and Gemstone carat total weight may vary 10-20% from
                  stated weight. Color and clarity grades are expressed as a
                  minimum. In some cases, we list the minimum color and clarity
                  of both the center diamond and the side diamonds. These
                  details can be found in the product details of the item on the
                  product page.
                </p>
                <p>
                  A customer may only place one diamond ring or loose diamond
                  order at a time. If multiple orders of a similar product
                  category are placed, we reserve the right to cancel one order.
                  Our team will make efforts to contact the customer prior to
                  cancellation. If in the event two orders are placed and
                  fulfilled, one will be eligible for return and the other will
                  be final sale and not eligible for exchange.&nbsp;
                </p>
                ...
                <p>
                  ...
                  use it for any commercial purpose, or any public display,
                  performance, sale or rental, (b) decompile, reverse engineer,
                  or disassemble the content, or (c) remove any copyright,
                  trademark registration, or other proprietary notices from the
                  content. You further agree not to access or use any The Carat
                  Casa website in any manner that may be harmful to the
                  operation of the website or its content.
                </p>
                <p>
                  The Website and the Services (collectively, the “The Carat
                  Casa Properties”) are protected by copyright laws throughout
                  ...
                  any web pages contained in the Website (except that we grant
                ...
                <p>
                  ...
                  the extent permitted by applicable law, we may also modify
                  these Mobile Terms at any time and your continued use of the
                  Service following the effective date of any such changes shall
                ...
                <p>
                  ...
                  system or other technology. Service-related messages may
                  include updates, alerts, and information (e.g., order updates,
                  account alerts, etc.). Promotional messages may include
                ...
                <p>
                  ...
                  initiated by you. If you have subscribed to other The Carat
                  Casa mobile message programs and wish to cancel, except where
                  applicable law requires otherwise, you will need to opt out
                  separately from those programs by following the instructions
                ...
                <p>
                  ...
                  infringements of intellectual property rights or otherwise
                  objectionable or injurious to third parties and do not contain
                  or consist of viruses, political campaigning, commercial
                ...
                <h2 className="display-12">Limitation of Liability</h2>
                <p>
                ...
                <p>
                  The law of certain states may not allow limitations on
                ...
                <p>
                  You agree to defend, indemnify, and hold harmless The Carat
                ...
                <h2 className="display-12">Termination</h2>
                <p>
                  Notwithstanding any of these Terms and Conditions, The Carat
                  Casa reserves the right, without notice and in its sole
                  discretion, to terminate your license to use this site, and to
                  block or prevent future your access to and use of the website.
                </p>
                <h2 className="display-12">Applicable Law</h2>
                <p>
                ...
                <h2 className="display-12">Severability</h2>
                <p>
                ...
                <ul>
                  <li data-uw-rm-sr="">
                    By accepting these terms and conditions, the customer agrees
                    to a $100.00 per home preview ring charge as authorization
                    and verification of customer billing information. This
                    information is held in confidence and is solely for the
                  ...
                  <li>
                    The customer is limited to two replica rings per order, with
                  ...
                  <li>
                    All replica orders ship free of charge to and from the
                  ...
                  <li>
                    ...
                    packaging. The customer need not return the included
                    paperwork such as the brochure and replica packing slip.
                  </li>
                  <li data-uw-rm-sr="">
                  ...
                  <li>
                    The customer is liable for damage, loss, theft and
                  ...
                  <li>
                    ...
                    for visual purposes, not extended wear, which may result in
                    damage or tarnish. Replica alloys are not hypoallergenic and
                    can cause an allergic reaction from extended wear.
                  </li>
                  <li>
                    This service is currently available only within the United
                    States.
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    Not valid on gift card purchases, past orders, or custom
                    orders unless otherwise specified.
                  </li>
                  <li>One-time use per customer.</li>
                  <li>
                    Offer subject to change or cancellation at any time without
                    notice. By using this code, you agree to these terms.
                  </li>
                </ul>
                <h2 className="display-12" id="offers-&amp;-promotions">
                  Offers &amp; Promotions
                </h2>
                <p data-uw-rm-sr="">
                  ...
                  will continue to run until further notice or until stock
                  lasts. Offer cannot be applied retroactively and is not
                  applicable on orders that are in processing or have shipped.
                  The offer cannot be combined with any other offer, discount,
                  or promotion code. Any free gift sent with purchase, must be
                  returned if an order is being returned and will not be
                  replaced if misplaced, lost or stolen. In the event that the
                  customer returns their purchase and does not return the free
                  gift with their order, they will be refunded the total value
                  of the order minus value of the free gift. Free gift is
                  limited to one per customer/shipping address. Free gifts
                  cannot be returned or exchanged for their cash value or any
                  other merchandise on site. The offer terms are subject to
                  change at any time without prior notice. Other restrictions
                  may apply.
                </p>
                <p>
                  Our Exclusive Offers are only applicable on select styles.
                  Prices for discounted items which are a part of Exclusive
                  Offers are marked on site. No promotion code is necessary to
                  avail the discount. The Exclusive Offers will continue to run
                  until further notice. Other restrictions may apply.
                </p>
                <h2 className="display-12">
