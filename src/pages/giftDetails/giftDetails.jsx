...
//     // Making charges 3% of product price
//     const makingCharges = (productPrice * 3) / 100;
    
//     // Subtotal = Product price + Making charges
//     const subtotal = productPrice + makingCharges;
...
//           </div>
//           <div className="price-breakup-row d-flex justify-content-between mb-2">
//             <span><strong>GST (3%)</strong></span>
//             <span>₹{priceBreakup.gst}</span>
//           </div>
...
//         <div className="price-breakdown-percentages mt-4 p-3 bg-light rounded">
//           <h6 className="mb-2"><strong>Breakdown:</strong></h6>
//           <div className="row small">
//             <div className="col-6">
//               <div className="mb-1">Product Price:</div>
//               <div className="mb-1">Making Charges (%):</div>
//               <div className="mb-1">GST (%):</div>
//               <div className="mb-0"><strong>Total:</strong></div>
//             </div>
//             <div className="col-6 text-end">
//               <div className="mb-1">₹{priceBreakup.productPrice}</div>
//               <div className="mb-1">₹{priceBreakup.makingCharges}</div>
//               <div className="mb-1">₹{priceBreakup.gst}</div>
//               <div className="mb-0"><strong>₹{priceBreakup.grandTotal}</strong></div>
//             </div>
//           </div>
//         </div>
//       </div>
...
//                     >
//                       <h5 className="detail-section-title">Price Breakup</h5>
//                       {openSection === "priceBreakup" ? (
//                         <ChevronUp size={20} className="chevron-icon" />
//                       ) : (
//                         <ChevronDown size={20} className="chevron-icon" />
//                       )}
//                     </div>
//                     <div
//                       className={`section-content ${openSection === "priceBreakup" ? "" : "collapsed"
//                         }`}
//                     >
//                       <PriceBreakupSection />
//                     </div>
...
//             {/* Price Breakup Section for Mobile */}
//             <div>
//               <div
//                 className="detail-section-header"
//                 onClick={() => toggleSection("priceBreakup")}
...
const GiftDetails = () => {
  ...
  // Calculate price breakup with all taxes including Diamond GST
  const calculatePriceBreakup = () => {
    const productPrice = parseFloat(price) || 0;
    
    // Get tax rates from selectedVariation
    const taxRates = selectedVariation?.tax_rates || [];
    ...
    // Extract tax rates
    let goldGstRate = 0;
    let makingChargesGstRate = 0;
    let diamondGstRate = 0;
    
    taxRates.forEach(tax => {
      if (tax.id === 2) { // Gold GST
        goldGstRate = parseFloat(tax.rate) || 0;
      } else if (tax.id === 3) { // Making Charges GST
        makingChargesGstRate = parseFloat(tax.rate) || 0;
      } else if (tax.id === 1) { // Diamond GST
        diamondGstRate = parseFloat(tax.rate) || 0;
      }
    });
    
    // Default values if not found
    if (goldGstRate === 0) goldGstRate = 3.00;
    if (makingChargesGstRate === 0) makingChargesGstRate = 3.00;
    if (diamondGstRate === 0) diamondGstRate = 0.25;
    
    // Calculate individual taxes
    const goldGst = (productPrice * goldGstRate) / 100;
    const makingChargesGst = (makingCharges * makingChargesGstRate) / 100;
    const diamondGst = (productPrice * diamondGstRate) / 100;
    
    const totalGst = goldGst + makingChargesGst + diamondGst;
    ...
    return {
      ...
      makingCharges: makingCharges.toFixed(2),
      subtotal: subtotal.toFixed(2),
      goldGst: goldGst.toFixed(2),
      makingChargesGst: makingChargesGst.toFixed(2),
      diamondGst: diamondGst.toFixed(2),
      totalGst: totalGst.toFixed(2),
      grandTotal: grandTotal.toFixed(2),
      goldGstRate,
      makingChargesGstRate,
      diamondGstRate
    };
  };
