...
const GiftDetails = () => {
  ...
  const baseOriginalPrice = parseFloat(original_price) || 0;
  const makingCharges = parseFloat(making_charges) || 0;
  const priceWithoutGST = parseFloat(price_without_gst) || 0;
  const taxAmount = parseFloat(tax_amount) || 0;
  const priceWithTax = parseFloat(price_with_tax) || 0;
  ...
  // Calculate price breakdown WITHOUT diamond GST
  const priceBreakup = {
    productPrice: basePrice,
    makingCharges: makingCharges,
    subtotal: basePrice + makingCharges,
    goldGstRate: parseFloat(gold_gst_rate) || 0,
    makingChargesGstRate: parseFloat(making_gst_rate) || 0,
    goldGst: goldGst,
    makingChargesGst: makingGst,
    totalGst: totalGstWithoutDiamond,
    grandTotal: finalPriceWithGST
  };
        ...
        <div className="container">
          <div className="row" style={{ "--bs-gutter-x": "2.5rem" }}>
            ...
            <div className="col-5">
              ...
              {/* MAIN PRICE DISPLAY (without GST) */}
              <div className="mb-4">
                <span className="h3 fw-bold">₹{formatCurrency(final_price)}</span>
                <span className="fs-5 text-decoration-line-through ms-2">
                  ₹{formatCurrency(final_original_price)}
                </span>
                <span className="text-green-custom ms-2">
                      ...
                      <div className="price-breakup-section">
                        ...
                        <div className="price-breakup-totals">
                          ...
                          <div className="price-breakup-row d-flex justify-content-between mb-2">
                            ...
                            <span>₹{formatCurrency(priceBreakup.makingCharges)}</span>
                          </div>
                          <div className="price-breakup-row d-flex justify-content-between mb-2">
                            <span><strong>Subtotal</strong></span>
                          ...
                          <div className="gst-breakdown mt-3 mb-3">
                            ...
                            <div className="price-breakup-row d-flex justify-content-between mb-1 ps-3">
                              <span>Gold GST ({priceBreakup.goldGstRate}%)</span>
                              <span>₹{formatCurrency(priceBreakup.goldGst)}</span>
                            </div>
                            <div className="price-breakup-row d-flex justify-content-between mb-1 ps-3">
                              <span>Making Charges GST ({priceBreakup.makingChargesGstRate}%)</span>
                              <span>₹{formatCurrency(priceBreakup.makingChargesGst)}</span>
                            </div>
                            <div className="price-breakup-row d-flex justify-content-between border-top pt-2">
                              <span><strong>Total GST</strong></span>
                              <span><strong>₹{formatCurrency(priceBreakup.totalGst)}</strong></span>
                            </div>
                          </div>
                        ...
                        <div className="price-summary mt-4 p-3 bg-light rounded">
                          ...
                          <div className="row small">
                            ...
                            <div className="col-6 text-end">
                              <div className="mb-1">₹{formatCurrency(priceBreakup.productPrice)}</div>
                              <div className="mb-1">₹{formatCurrency(priceBreakup.makingCharges)}</div>
                              <div className="mb-1">₹{formatCurrency(priceBreakup.goldGst)}</div>
                              <div className="mb-1">₹{formatCurrency(priceBreakup.makingChargesGst)}</div>
                              <div className="mb-0 mt-2"><strong>₹{formatCurrency(priceBreakup.grandTotal)}</strong></div>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className="d-block d-md-none">
        ...
        <div className="p-3 pb-0">
          ...
          <div className="product-details-container">
            ...
            {/* Price & Tax Details Section - Mobile */}
            <div>
              <div
                className="detail-section-header"
                onClick={() => toggleSection("tax")}
          ...
          <div className=" bg-white p-3 pt-1 border-top">
            <div className="d-flex align-items-center justify-content-between gap-3">
              <div>
                ...
                <div className="h5 fw-bold mb-0">₹{formatCurrency(final_price)}</div>
              </div>
              <button
                className="btn flex-grow-1 py-2 fw-semibold bg-brand-blue"
                style={{ backgroundColor: "#0060AC", color: "white" }}
