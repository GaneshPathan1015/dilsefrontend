...
const details = [
  {
    title: "The W Signature Jewellery—Where Form Meets Feeling",
    description:
...
<section className="w-signature-description py-5">
        ...
        <p className="description-text container">
          <strong>The Signature Jewellary</strong> showcases a distinctive W-shaped basket, inspired by the The CaratCasa brand name. Designed to celebrate the brilliance <br /> of the center stone, The Signature Jewellary embodies timeless artistry, creating an iconic silhouette that remains classic for generations to come.
        </p>
